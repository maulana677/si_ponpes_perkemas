<div class="main-sidebar">
    <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="responsive"><a class="nav-link" href="/dashboard"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>
			      @if(Auth::user()->role == 'admin')
            <li class="menu-header">Kelola Data</li>
            <li class=""><a class="nav-link" href="/user"><i class="fas fa-users"></i> <span>User</span></a></li>
            <li class=""><a class="nav-link" href="/kategori_gaji"><i class="fas fa-user-tie"></i> <span>Jabatan</span></a></li>
            <li class=""><a class="nav-link" href="/kelas"><i class="fas fa-columns"></i> <span>Kelas</span></a></li>
            <li class=""><a class="nav-link" href="/tahun_ajaran"><i class="fas fa-calendar-alt"></i> <span>Tahun Ajaran</span></a></li>
            ...
            <!-- <li class=""><a class="nav-link" href="/donatur"><i class="fas fa-user-tie"></i> <span>Donatur</span></a></li> -->
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="/biodata_mudhir">Biodata Karyawan</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <!-- <ul class="dropdown-menu"> -->
                <li class=""><a class="nav-link" href="/pemasukan"><i class="fas fa-dollar-sign"></i> <span>Pemasukan</span></a></li>
                <li class=""><a class="nav-link" href="/pengeluaran"><i class="fas fa-dollar-sign"></i> <span>Pengeluaran</span></a></li>
            ...
            <li class=""><a class="nav-link" href="/spp"><i class="fas fa-money-bill-wave"></i> <span>SPP</span></a></li>
            <li class=""><a class="nav-link" href="/pembayaran_spp"><i class="fas fa-money-bill-wave"></i> <span>Entri Pembayaran SPP</span></a></li>
            ...
            <li class=""><a class="nav-link" href="/pembayaran_gaji"><i class="fas fa-hand-holding-usd"></i> <span>Entri Pembayaran Gaji</span></a></li>
            ...
            <!-- <li class=""><a class="nav-link" href="/infak"><i class="fas fa-donate"></i> <span>Infak</span></a></li> -->
            <li class=""><a class="nav-link" href="/cetak_laporan/keuangan_ponpes"><i class="fas fa-file-alt"></i> <span>Keuangan Ponpes</span></a></li>
            <li class=""><a class="nav-link" href="/cetak_laporan/pembayaran_spp"><i class="fas fa-file-alt"></i> <span>Pembayaran SPP</span></a></li>
            <li class=""><a class="nav-link" href="/cetak_laporan/pembayaran_gaji"><i class="fas fa-file-alt"></i> <span>Pembayaran Gaji</span></a></li>
            @endif
            ...
            <li class="menu-header">Siswa</li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="/biodata_siswa/detail">Biodata Siswa</a></li>
                </ul>
              </li>
              <li class=""><a class="nav-link" href="/pembayaran_spp_siswa"><i class="fas fa-money-bill-wave"></i> <span>History SPP</span></a></li>
            @endif
            <!-- <li class="nav-item">
