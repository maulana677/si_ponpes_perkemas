...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <form method="POST" action="{{route('cetak_laporan.pembayaran_gaji.filterByTanggal')}}">
                                        {{csrf_field()}}
                                ...
                                <div class="col-md-4">
                                    <form method="POST" action="{{route('cetak_laporan.pembayaran_gaji.filterByKategori')}}">
                                        {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="{{route('cetak_laporan.pembayaran_gaji.cetak')}}" target="_blank">
                        {{csrf_field()}}
                    ...
                    <a class="btn btn-success btn-sm my-2 mr-sm-2 float-right" href="{{route('cetak_laporan.pembayaran_gaji.index')}}" role="button"><i class="fas fa-sync-alt"></i> Refresh</a>
                </div>
            </div>
