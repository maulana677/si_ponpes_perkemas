    ...
    <div class="main-content">
        <section class="section">
            <div class="card" style="width:100%;">
                <div class="card-body">
                    <h2 class="card-title text-uppercase" style="color: black;">Detail Mudhir — {{ $biodatamudhir->nama_mudhir }} </h2>
                    <hr>
                    <p class="card-text"> Berikut adalah detail mudhir dari mudhir yang bernama {{$biodatamudhir->nama_mudhir}}. Detail
                        meliputi Nama Mudhir, Alamat, No Telepon, Jenis Kelamin, Pendidikan, Bidang.
                    </p>
                </div>
            </div>
                    ...
                    <div class="col-12 ">
                        ...
                        <div class="col-md-12 text-center">
                            <p class="registration-title font-weight-bold display-4 mt-4" style="color:black; font-size: 50px;">
                                Detail Data Mudhir</p>
                            <p style="line-height:-30px;margin-top:-20px;">Berikut adalah data mudhir dari {{ $biodatamudhir->nama_mudhir }} </p>
                            <hr>
                        </div>
                            <div class="card-body">
