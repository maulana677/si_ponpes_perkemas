...
class LaporanController extends Controller
{
    ...
    public function tKeuanganPonpesfilterByTanggal(Request $request)
    {
        ...
        $data_pemasukan = Pemasukan::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->orderByRaw('created_at DESC')->get();
        $total_pemasukan = Pemasukan::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->sum('jumlah');

        $data_pengeluaran = Pengeluaran::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->orderByRaw('created_at DESC')->get();
        $total_pengeluaran = Pengeluaran::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->sum('jumlah');
    ...
    public function tKeuanganPonpesCetak(Request $request)
    {
        ...
        if ($data_id_kategori == null && $tgl_awal != null) {
            $data_pemasukan = Pemasukan::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->get();
            $total_pemasukan = Pemasukan::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->sum('jumlah');
    
            $data_pengeluaran = Pengeluaran::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->get();
            $total_pengeluaran = Pengeluaran::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->sum('jumlah');
        }
        ...
        elseif($data_id_kategori == null && $tgl_awal == null){
            ...
            $data_pemasukan = Pemasukan::where('id_kategori', $data_id_kategori)->whereBetween('created_at', [$tgl_awal, $tgl_akhir])->get();
            $total_pemasukan = Pemasukan::where('id_kategori', $data_id_kategori)->whereBetween('created_at', [$tgl_awal, $tgl_akhir])->sum('jumlah');
    
            $data_pengeluaran = Pengeluaran::where('id_kategori', $data_id_kategori)->whereBetween('created_at', [$tgl_awal, $tgl_akhir])->get();
            $total_pengeluaran = Pengeluaran::where('id_kategori', $data_id_kategori)->whereBetween('created_at', [$tgl_awal, $tgl_akhir])->sum('jumlah');
        }
    ...
    public function tPembayaranGajiIndex()
    {
        ...
        return view('/cetak_laporan.pembayaran_gaji.index', compact('daftar_kategori_gaji', 'data_id_kategori_gaji', 'tgl_awal', 'tgl_akhir', 'data_pembayaran_gaji','biodatamudhir'));
    }
    ...
    public function tPembayaranGajifilterByKategori(Request $request)
    {
        ...
        return view('/cetak_laporan.pembayaran_gaji.index', compact('daftar_kategori_gaji', 'data_id_kategori_gaji', 'tgl_awal', 'tgl_akhir', 'data_pembayaran_gaji', 'total_pembayaran_gaji', ));
    }
    ...
    public function tPembayaranGajifilterByTanggal(Request $request)
    {
        ...
        $data_pembayaran_gaji = PembayaranGaji::whereBetween('created_at', [$tgl_awal, $tgl_akhir])->orderByRaw('created_at DESC')->get();
    ...
    public function tPembayaranGajiCetak(Request $request)
    {
        ...
        // return $request;
        return view('/cetak_laporan.pembayaran_gaji.cetak', compact( 'pembayarangaji','tgl_awal', 'tgl_akhir', 'data_pembayaran_gaji', 'total_pembayaran_gaji'));
    ...
    public function tPembayaranSPPIndex()
    {
        ...
        return view('/cetak_laporan.pembayaran_spp.index', compact('daftar_kategori_kelas', 'data_id_kategori_kelas', 'tgl_awal', 'tgl_akhir', 'data_pembayaran_spp','biodatasiswa'));
    }
    ...
    public function tPembayaranSPPfilterByKategori(Request $request)
    {
        ...
        return view('/cetak_laporan.pembayaran_spp.index', compact('daftar_kategori_kelas', 'data_id_kategori_kelas', 'tgl_awal', 'tgl_akhir', 'data_pembayaran_spp', 'total_pembayaran_spp', ));
    }
    ...
    public function tPembayaranSPPCetak(Request $request)
    {
        ...
        return view('/cetak_laporan.pembayaran_spp.cetak', compact( 'pembayaranspp','tgl_awal', 'tgl_akhir', 'data_pembayaran_spp', 'total_pembayaran_spp'));
