...
Route::get('/cetak_laporan/pembayaran_gaji', [LaporanController::class, 'tPembayaranGajiIndex'])->name('cetak_laporan.pembayaran_gaji.index');
Route::post('/cetak_laporan/pembayaran_gaji/filterByKategori', [LaporanController::class, 'tPembayaranGajifilterByKategori'])->name('cetak_laporan.pembayaran_gaji.filterByKategori');
Route::post('/cetak_laporan/pembayaran_gaji/filterByTanggal', [LaporanController::class, 'tPembayaranGajifilterByTanggal'])->name('cetak_laporan.pembayaran_gaji.filterByTanggal');
Route::get('/cetak_laporan/pembayaran_gaji/DownloadExcel', [LaporanController::class, 'tPembayaranGajiDownloadExcel'])->name('cetak_laporan.pembayaran_gaji.DownloadExcel');
Route::post('/cetak_laporan/pembayaran_gaji/cetak', [LaporanController::class, 'tPembayaranGajiCetak'])->name('cetak_laporan.pembayaran_gaji.cetak');

//Laporan Pembayaran SPP
Route::get('/cetak_laporan/pembayaran_spp', [LaporanController::class, 'tPembayaranSPPIndex'])->name('cetak_laporan.pembayaran_spp.index');
Route::post('/cetak_laporan/pembayaran_spp/filterByKategori', [LaporanController::class, 'tPembayaranSPPfilterByKategori'])->name('cetak_laporan.pembayaran_spp.filterByKategori');
Route::post('/cetak_laporan/pembayaran_spp/filterByTanggal', [LaporanController::class, 'tPembayaranSPPfilterByTanggal'])->name('cetak_laporan.pembayaran_spp.filterByTanggal');
Route::get('/cetak_laporan/pembayaran_spp/DownloadExcel', [LaporanController::class, 'tPembayaranSPPDownloadExcel'])->name('cetak_laporan.pembayaran_spp.DownloadExcel');
Route::post('/cetak_laporan/pembayaran_spp/cetak', [LaporanController::class, 'tPembayaranSPPCetak'])->name('cetak_laporan.pembayaran_spp.cetak');
